...
public class JwtTest {
    ...
    public void testGen() {
        ...
        String token = JWT.create()
                ...
                .withExpiresAt(new Date(System.currentTimeMillis() + 1000000))//添加过期时间
                .sign(Algorithm.HMAC256("lyy"));//指定算法,配置秘钥
    ...
    public void testParse() {
        ...
        JWTVerifier jwtVerifier = JWT.require(Algorithm.HMAC256("lyy")).build();
